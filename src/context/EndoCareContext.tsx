...
type EndoCareAction =
  ...
  | { type: 'LOAD_API_DATA'; payload: { sleep: SleepLog[]; diet: FoodLog[]; menstrual: PeriodLog[]; symptoms: SymptomEntry[] } };
...
export function EndoCareProvider({ children }: { children: ReactNode }) {
  ...
  const loadInitialData = async () => {
    ...
    try {
      ...
      console.error('[context] Failed to load initial data:', error);
